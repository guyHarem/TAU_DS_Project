...
def main():
    ...
    # Declare model
    model = LSTMSpreadModel(sequence_length=20, lstm_units=64, dense_units=32, dropout_rate=0.2, random_state=args.seed)
    ...
    # Plot
    model.plot_results(model.y_test, y_pred, save_path=output_dir / f'lstm_{crypto}_results.png')
    model.plot_prediction_hist(y_pred, save_path=output_dir / f'lstm_{crypto}_prediction_hist.png')
    model.plot_training_history(save_path=output_dir / f'lstm_{crypto}_training_history.png')
